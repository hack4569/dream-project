...
public class RecommendServiceImpl implements RecommendService {
	...
	public List<List> getRecommendList(String user_id) throws Exception{
		...
		//베스트셀러
		aladinBestSellerBooks = this.bestSellerList(aladinBestSellerBooks, startIdx, maxResults);
		//책소개
	...
	public List<AladinBook> bestSellerList(List<AladinBook> aladinBooks, int startIdx, int maxResults){
		String userId = "admin";
		...
		if(aladinBooks.size()<5){
			this.bestSellerList(aladinBooks,++startIdx, maxResults);
		}
		return aladinBooks;
	}
